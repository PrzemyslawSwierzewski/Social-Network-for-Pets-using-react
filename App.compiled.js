  ...
  var Profile = exports.Profile = _wrapComponent('Profile')(function (_React$Component) {
    ...
    _createClass(Profile, [{
      ...
      value: function render() {
        ...
        var name = isLoading === true ? 'Loading...' : this.state.userData.name;
        var bio = isLoading === true ? 'Loading...' : this.state.userData.bio;
        var friends = isLoading === true ? [] : this.state.userData.friends;
        return _react3.default.createElement(
          'div',
          { className: className },
          _react3.default.createElement(
